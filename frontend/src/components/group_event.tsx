  ...
  evt_005: [
    {
      ...
      userAvatar:
        "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face",
      message:
        "Sự kiện dọn biển sẽ bắt đầu sớm để tránh nắng. Mọi người chuẩn bị sẵn sàng! 🏖️",
      timestamp: "05:30",
      isCurrentUser: false,
    },
  ],
  ...
  evt_003: [
    {
      ...
      eventId: "evt_003",
      content:
        "Hôm nay chúng ta đã nấu được 200 suất cơm để phát cho bà con nghèo! Cảm ơn mọi người đã đóng góp tâm huyết 🍚❤️",
      images: [
  ...
  evt_004: [
    {
      ...
      eventId: "evt_004",
      content:
        "Thông báo: Sự kiện hiến máu sẽ có xe đưa đón từ trung tâm thành phố. Liên hệ với ban tổ chức để đăng ký 🚌🩸",
  ...
  evt_005: [
    {
      ...
      eventId: "evt_005",
      content:
        "Chuẩn bị cho sự kiện dọn bãi biển! Mọi người nhớ mang theo găng tay, túi rác và kem chống nắng nhé 🏖️🧤",
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Sự kiện với ID "{eventId}" không tồn tại.
          </p>
        </div>
      </div>
    );
      ...
      <div className="flex-1 max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          ...
          <div className="flex flex-wrap gap-4 text-sm text-gray-500">
            ...
            <span>
              👥 {event.currentParticipants}/{event.maxParticipants} người tham
              gia
            </span>
          </div>
        </div>
