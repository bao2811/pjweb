    ...
    <nav className="sticky top-0 w-full z-50 bg-blue-400 shadow-lg">
      <div className="container mx-auto px-3 sm:px-6 py-2">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-3 lg:gap-6">
          ...
          {/* Navigation Links - Horizontal scroll on mobile, normal on desktop */}
          <div className="flex items-center justify-center gap-2 sm:gap-4 bg-gray-200 rounded-full px-3 sm:px-6 py-2 w-full lg:w-auto overflow-x-auto scrollbar-hide">
            <Link
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              >
                {user?.image ? (
                  ...
                  <FaUserCircle className="text-white h-8 w-8 sm:h-10 sm:w-10" />
                )}
