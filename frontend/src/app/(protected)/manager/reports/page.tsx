    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 py-8">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Thống kê hoạt động tình nguyện của bạn</p>
        </div>
        ...
        {overview && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-purple-500">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-800">{overview.total_events}</p>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-blue-500">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-800">{overview.total_volunteers}</p>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-green-500">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-800">{overview.total_completed}</p>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-orange-500">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-500 mb-1">Tổng giờ hoàn thành</p>
                  <p className="text-3xl font-bold text-gray-800">{overview.total_hours.toFixed(1)}h</p>
                </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-purple-50">
                  <tr>
                    <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700">Tên sự kiện</th>
                    ...
                    <th className="px-4 py-3 text-center text-sm font-semibold text-gray-700">Đã duyệt</th>
                    <th className="px-4 py-3 text-center text-sm font-semibold text-gray-700">Hoàn thành</th>
                    <th className="px-4 py-3 text-center text-sm font-semibold text-gray-700">Tỉ lệ</th>
                    <th className="px-4 py-3 text-center text-sm font-semibold text-gray-700">Giờ</th>
                ...
                <tbody className="divide-y divide-gray-200">
                  {events.map((event) => (
                    <tr key={event.id} className="hover:bg-gray-50 transition">
                      ...
                      <td className="px-4 py-4 text-center">{getStatusBadge(event.status)}</td>
                      <td className="px-4 py-4 text-center">
                        <span className="font-semibold text-blue-600">{event.approved}</span>
                        <span className="text-gray-500 text-sm">/{event.total_registered}</span>
                      </td>
                      <td className="px-4 py-4 text-center">
                        <span className="font-semibold text-green-600">{event.completed}</span>
                      </td>
                      <td className="px-4 py-4 text-center">
                        <div className="flex flex-col items-center">
                          <span className="font-semibold text-gray-800">{event.completion_rate}%</span>
                      ...
                      <td className="px-4 py-4 text-center">
                        <span className="font-semibold text-orange-600">{event.total_hours}h</span>
                      </td>
                      <td className="px-4 py-4 text-center">
                        <Link
